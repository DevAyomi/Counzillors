...
<html lang="en">
  <head>
    ...
    <title>Register as counsellor</title>
  </head>
  <body>
      ...
      <div class="row">
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="mb-4">
              <h3>Sign In as a <strong>Counsellor</strong></h3>
              <p class="mb-4">Counzilors... a web app that connect counsellors and counsilees</p>
            </div>


            <form action="{{ route('counsellor.register') }}" method="post">
            	@csrf
              ...
              <div class="d-flex mb-5 align-items-center">
                <label class="control control--checkbox mb-0"><span class="caption"><a href="{{ route('counsellee.register-view') }}">Register as counsellee</a></span>
              ...
              <span class="d-block text-left my-4 text-muted"><a href="{{ route('counsellors.login-view') }}">Already have an account</a></span>
