...
<html lang="en">
  <head>
    ...
    <title>Login as counsellor</title>
  </head>
  <body>
        ...
        <div class="col-md-6 contents">
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <h3>Login as a <strong>Counsellor</strong></h3>
            ...
            <form action="{{route('counsellor.logins')}}" method="post">
              @csrf
              ...
              <div class="d-flex mb-5 align-items-center">
                <label class="control control--checkbox mb-0"><span class="caption"><a href="{{ route('counsellee.login-view') }}">Login as counsellee</a></span>
              ...
              <span class="d-block text-left my-4 text-muted"><a href="{{ route('counsellor.register-view') }}">Dont have an account</a></span>
